...
> Source: [https://nixos.org/guides/how-nix-works/](https://nixos.org/guides/how-nix-works/)
...
NixOS is based on [Nix](https://nixos.org/), a purely functional package management system. Nix stores all packages in isolation from each other under paths such as
...
In NixOS, the entire operating system — the kernel, applications, system packages, configuration files, and so on — is built by the [Nix package manager](https://nixos.org/) from a description in a purely functional build language. The fact that it’s purely functional essentially means that building a new configuration cannot overwrite previous configurations. Most of the other features follow from this.
