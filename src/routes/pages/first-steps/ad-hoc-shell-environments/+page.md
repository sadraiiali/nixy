...
هنگامی که [نیکس را نصب کردید](https://nix.dev/install-nix)، می‌توانید از آن برای ایجاد *محیط‌های شل* جدید با برنامه‌هایی که می‌خواهید استفاده کنید، بهره ببرید.
...
- [reproducible-scripts](/pages/first-steps/reproducible-scripts) استفاده از Nix برای اسکریپت‌های تکرارپذیر
- [reading-nix-language](https://nix.dev/tutorials/nix-language) یادگیری نحوه خواندن زبان Nix که برای اعلام بسته‌ها و پیکربندی‌ها استفاده می‌شود
- [declarative-reproducible-envs](/pages/first-steps/declarative-shell) ایجاد محیط‌های شل تکرارپذیر با یک فایل پیکربندی اعلانی (declarative)
- [pinning-nixpkgs](/pages/first-steps/pinning-nixpkgs) یادگیری روش‌های مختلف مشخص کردن نسخه‌های دقیق منابع بسته
