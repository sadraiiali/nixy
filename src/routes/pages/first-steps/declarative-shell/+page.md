...
در آموزش [ad-hoc-envs](/pages/first-steps/ad-hoc-shell-environments)، یاد گرفتید که چگونه با استفاده از `nix-shell -p` به روش دستوری (imperative) محیط‌های شل ایجاد کنید.
...
- آشنایی با شل یونیکس
- درک مقدماتی از [زبان Nix](https://nix.dev/tutorials/nix-language)
...
> **جزئیات**: توضیحات تفصیلی
>
> ما از نسخه‌ای از [Nixpkgs سنجاق‌شده به یک شاخه انتشار](https://nix.dev/reference/pinning-nixpkgs) استفاده می‌کنیم.
> اگر آموزش [ad-hoc-envs](/pages/first-steps/ad-hoc-shell-environments) را دنبال کرده‌اید و نمی‌خواهید تمام وابستگی‌ها را دوباره بارگیری کنید، دقیقاً همان ریویژن (revision) مشخص‌شده در بخش [towards-reproducibility](/pages/first-steps/ad-hoc-shell-environments) را تعیین کنید:
>
>
> 
...
>
> > **جزئیات**: نکته‌ی حاشیه‌ای درباره‌ی `mkShell`
> >
> >
...
- [reading-nix-language](https://nix.dev/tutorials/nix-language)
- [automatic-direnv](automatic-direnv)
- [sharing-dependencies](../../guides/recipes/sharing-dependencies.md)
- [dependency-management](../../guides/recipes/dependency-management.md)
