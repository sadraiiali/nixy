...
- [reading-nix-language](https://nix.dev/tutorials/nix-language) برای کسب اطلاعات درباره‌ی زبان Nix که برای اعلام بسته‌ها و پیکربندی‌ها استفاده می‌شود.
- [declarative-reproducible-envs](/pages/first-steps/declarative-shell) برای ایجاد محیط‌های شل بازتولیدپذیر با یک فایل پیکربندی اعلانی (declarative).
