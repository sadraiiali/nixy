# <a id="ref-pinning-nixpkgs"></a> سنجاق کردن Nixpkgs
...
- استفاده از آخرین کامیت روی شاخهٔ انتشار، اما هنوز آزمایش‌نشده:
```
...
- فهرست کانال‌های نسخهٔ فعال - هنگام پیگیری آخرین نسخه‌های کانال از آن استفاده کنید.
...
> **راهنمایی**
>
> اطلاعات بیشتر درباره نسخه‌های Nixpkgs و NixOS: [channel-branches](/pages/nix-dev/concepts/faq)
