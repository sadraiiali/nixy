# <a id="packaging-tutorial"></a> بسته‌بندی نرم‌افزارهای موجود با Nix
...
- باید در [خواندن زبان Nix](/pages/nix-dev/tutorials/nix-language) تسلط کافی داشته باشید. در صورت نیاز می‌توانید ابتدا به عقب بازگشته و آن آموزش را مرور کنید.
...
> **نکته**
>
> یک _بسته_ مفهومی است که تعریف آزادی دارد و به مجموعه‌ای از فایل‌ها و داده‌های دیگر یا به یک *عبارت نیکس (Nix expression)* که نماینده‌ی چنین مجموعه‌ای پیش از تحقق یافتن آن است، اشاره دارد.
...
>
> آموزش [callpackage](/pages/nix-dev/tutorials/callpackage) به جزئیات نحوه عملکرد این موضوع می‌پردازد.
...
- [callpackage-tutorial](/pages/nix-dev/tutorials/callpackage)
...
- [python-dev-environment](/pages/nix-dev/guides/recipes/python-environment)
- [افزودن بسته‌های جدید خود به Nixpkgs](https://github.com/NixOS/nixpkgs/blob/master/CONTRIBUTING.md)
  - [how-to-contribute](/pages/nix-dev/contributing/how-to-contribute)
  - [how-to-get-help](/pages/nix-dev/contributing/how-to-get-help)
