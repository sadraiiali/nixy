...
> > > > ```
> > > 
> > > راهنمای NixOS دارای فصل‌هایی درباره [X11](https://nixos.org/manual/nixos/stable/#sec-x11) و [Wayland](https://nixos.org/manual/nixos/stable/#sec-wayland) است که مدیران پنجره جایگزین را فهرست می‌کنند.
> > > 
> > > ## مراجع
> > > 
