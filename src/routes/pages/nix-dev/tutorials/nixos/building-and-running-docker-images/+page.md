# <a id="nixos-docker-images"></a> ساخت و اجرای تصاویر داکر
...
در این آموزش، شما یاد می‌گیرید چگونه با استفاده از Nix، کنتینرهای Docker بسازید.
...
مجموعه‌ی بسته‌های نیکس (Nixpkgs) ابزار `dockerTools` را برای ایجاد تصاویر داکر فراهم می‌کند:
...
>
> - [راه‌اندازی ساخت‌های توزیع‌شده](/pages/nix-dev/tutorials/nixos/distributed-builds-setup) برای ساخت روی لینوکس
> - [کامپایل متقاطع](/pages/nix-dev/tutorials/cross-compilation) به لینوکس با جایگزین کردن `pkgsLinux.hello` با `pkgs.pkgsCross.musl64.hello`
...
- ساخت تصاویر داکر در یک [CI با GitHub Actions](/pages/nix-dev/guides/recipes/continuous-integration-github-actions).
