# <a id="sharing-dependencies"></a> وابستگی‌ها در شل توسعه

هنگام [بسته‌بندی نرم‌افزار در `default.nix`](/pages/nix-dev/tutorials/packaging-existing-software)، احتمالاً می‌خواهید یک [محیط توسعه در `shell.nix`](/pages/nix-dev/tutorials/first-steps/declarative-shell) داشته باشید تا بتوانید به راحتی با `nix-shell` یا [به‌طور خودکار با `direnv`](/pages/nix-dev/guides/recipes/direnv) وارد آن شوید.
...
- [pinning-nixpkgs](/pages/nix-dev/tutorials/first-steps/towards-reproducibility-pinning-nixpkgs)
- [direnv](/pages/nix-dev/guides/recipes/direnv)
