# <a id="post-build-hooks"></a> راه‌اندازی قلاب‌های پس از ساخت
...
[custom-binary-cache](/pages/nix-dev/guides/recipes/add-binary-cache) روی هر ماشینی که قرار است به باکت دسترسی داشته باشد.
