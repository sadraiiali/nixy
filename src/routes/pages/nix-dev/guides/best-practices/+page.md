...
## <a id="rec-expression"></a> مجموعه ویژگی بازگشتی `rec {'{'}'{'{'}'{'}'} ... {'{'}'{'}'}'{'}'}`
...
## <a id="search-path"></a> مسیرهای جستجوی `&lt;...>`
...
برای مثال، دو توسعه‌دهنده روی ماشین‌های مختلف احتمالاً `&lt;nixpkgs&gt;` را به نسخه‌های متفاوتی از مخزن *Nixpkgs* ارجاع می‌دهند.
...
> **راهنمایی**
>
> با استفاده از روش‌های نشان‌داده‌شده در بخش [pinning-nixpkgs](/pages/nix-dev/tutorials/first-steps/towards-reproducibility-pinning-nixpkgs)، وابستگی‌ها را به صورت صریح اعلام کنید.
>
...
## <a id="nixpkgs-config"></a> پیکربندی بازتولیدپذیر Nixpkgs
...
با این حال، حتی زمانی که `&lt;nixpkgs&gt;` طبق تصویر نشان داده‌شده در [pinning-nixpkgs](/pages/nix-dev/tutorials/first-steps/towards-reproducibility-pinning-nixpkgs) جایگزین شود، ممکن است نتیجه همچنان کاملاً بازتولیدپذیر نباشد.
