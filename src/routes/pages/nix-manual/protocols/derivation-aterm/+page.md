# 10.5. قالب فایل «ATerm» مربوط به Derivation
...
تنها `version-string`هایی که امروزه استفاده می‌شوند مربوط به [ویژگی‌های آزمایشی](/pages/nix-manual/development/experimental-features) هستند:

  - `"xp-dyn-drv"` برای ویژگی آزمایشی [`dynamic-derivations`](/pages/nix-manual/development/experimental-features#xp-feature-dynamic-derivations).
...
[store object]: /pages/nix-manual/glossary#gloss-store-object
["Text" method]: /pages/nix-manual/store/store-object/content-address#method-text
