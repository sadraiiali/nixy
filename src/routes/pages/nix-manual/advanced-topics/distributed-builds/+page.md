...
[فهرست ماشین‌های بیلدرسازه راه دور](/pages/nix-manual/command-ref/conf-file#conf-builders) را می‌توان روی خط فرمان یا در فایل پیکربندی Nix مشخص کرد.
...
ماشین‌های ساخت راه دور را می‌توان در [`nix.conf`](/pages/nix-manual/command-ref/conf-file) نیز پیکربندی کرد، به عنوان مثال:
