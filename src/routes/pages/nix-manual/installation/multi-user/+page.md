...
[Nix daemon](/pages/nix-manual/command-ref/nix-daemon) باید به شکل زیر (در نقش `root`) اجرا شود:
...
[`متغیر محیطی NIX_REMOTE`](/pages/nix-manual/command-ref/env-common) را روی
