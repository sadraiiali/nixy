...
کاربران باید با فعال کردن پرچم‌های [ویژگی آزمایشی](/pages/nix-manual/command-ref/conf-file#conf-experimental-features) مرتبط، آن‌ها را به طور صریح فعال کنند.
این کار اجازه می‌دهد تا بدون اتکای ناخواسته به قابلیت‌های ناپایدار، به آن‌ها دسترسی پیدا کنید.

پرچم‌های ویژگی آزمایشی برای اولین بار در [Nix 2.4](/pages/nix-manual/development/release-notes/rl-2.4) معرفی شدند.
