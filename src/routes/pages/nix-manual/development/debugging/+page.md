...
علاوه بر این، برای دستورالعمل‌های بیشتر درباره نحوه دیباگ (اشکال‌زدایی) Nix در زمینه یک تست واحد یا تست کاربردی، به [آزمایش Nix](/pages/nix-manual/development/testing) مراجعه کنید.
