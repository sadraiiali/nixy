...
- `--force-realise` / `-f`
  ...
  ابتدا هر آرگومان پرس‌وجو را محقق (realise) کنید (ببینید [`nix-store --realise`](/pages/nix-manual/command-ref/nix-store/realise)).
...
- `--requisites` / `-R`
  ...
  [requisite]: glossary.md#gloss-requisite
...
- `--referrers`
  ...
  [referrer]: glossary.md#gloss-referrer
...
[deriver]: /pages/nix-manual/glossary#gloss-deriver
- `--valid-derivers`
