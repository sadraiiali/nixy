...
- [مسیر جستجوی عبارت Nix](/pages/nix-manual/command-ref/conf-file#conf-nix-path)، تنظیم‌شده با [گزینه `-I`](#opt-I) یا [متغیر محیطی `NIX_PATH`](#env-NIX_PATH)
...
> - [`fetchurl`](/pages/nix-manual/language/builtins#builtins-fetchurl)، [`fetchTarball`](/pages/nix-manual/language/builtins#builtins-fetchTarball)، یا [`fetchGit`](/pages/nix-manual/language/builtins#builtins-fetchGit) در عبارت‌های Nix
> - [گزینه `-I`](/pages/nix-manual/command-ref/opt-common#opt-I) در فراخوانی‌های خط فرمان
...
- `--update` \[*names*…\]
  ...
  > برای تغییر مدت زمان اعتبار دانلودهای کش‌شده، از `--tarball-ttl` یا [گزینه پیکربندی `tarball-ttl`](/pages/nix-manual/command-ref/conf-file#conf-tarball-ttl) استفاده کنید.
