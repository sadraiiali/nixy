...
> Source: [/pages/nix-manual/command-ref/new-cli/nix3-flake](/pages/nix-manual/command-ref/new-cli/nix3-flake)
...
- [`nix flake archive`](/pages/nix-manual/command-ref/experimental-commands) - copy a flake and all its inputs to a store
- [`nix flake check`](/pages/nix-manual/command-ref/experimental-commands) - check whether the flake evaluates and run its tests
- [`nix flake clone`](/pages/nix-manual/command-ref/experimental-commands) - clone flake repository
- [`nix flake info`](/pages/nix-manual/command-ref/experimental-commands) - show flake metadata
- [`nix flake init`](/pages/nix-manual/command-ref/experimental-commands) - create a flake in the current directory from a template
- [`nix flake lock`](/pages/nix-manual/command-ref/experimental-commands) - create missing lock file entries
- [`nix flake metadata`](/pages/nix-manual/command-ref/experimental-commands) - show flake metadata
- [`nix flake new`](/pages/nix-manual/command-ref/experimental-commands) - create a flake in the specified directory from a template
- [`nix flake prefetch`](/pages/nix-manual/command-ref/experimental-commands) - download the source tree denoted by a flake reference into the Nix store
- [`nix flake prefetch-inputs`](/pages/nix-manual/command-ref/experimental-commands) - fetch the inputs of a flake
- [`nix flake show`](/pages/nix-manual/command-ref/experimental-commands) - show the outputs provided by a flake
- [`nix flake update`](/pages/nix-manual/command-ref/experimental-commands) - update flake lock file
...
[Nix Archive (NAR) serialisation](/pages/nix-manual/store/file-system-object/content-address#serial-nix-archive)
...
that are looked up in [the flake registries](/pages/nix-manual/command-ref/experimental-commands).
These have the form
...
entry in the registry; see [nix registry](/pages/nix-manual/command-ref/experimental-commands) for
details.
...
- <a id="path-fetcher"></a>[/pages/nix-manual/command-ref/new-cli/nix3-flake](/pages/nix-manual/command-ref/new-cli/nix3-flake)`path`: arbitrary local directories. The required attribute `path`
...
Note that the allowed syntax for path values in flake `inputs` may be more restrictive than general Nix, so you may need to use `path:` if your path contains certain special characters. See [Path literals](/pages/nix-manual/language/syntax#path-literal)
...
can be dropped.
This can also be used to set the location of gitea/forgejo branches. [See here](/pages/nix-manual/protocols/tarball-fetcher#gitea-and-forgejo-support)
...
[installable](/pages/nix-manual/command-ref/experimental-commands#installables) derivation):
...
set of options is allowed to be set without confirmation so long as [`accept-flake-config`](/pages/nix-manual/command-ref/conf-file-prefix#conf-accept-flake-config) is not enabled in the global configuration:
  - [`bash-prompt`](/pages/nix-manual/command-ref/conf-file-prefix#conf-bash-prompt)
  - [`bash-prompt-prefix`](/pages/nix-manual/command-ref/conf-file-prefix#conf-bash-prompt-prefix)
  - [`bash-prompt-suffix`](/pages/nix-manual/command-ref/conf-file-prefix#conf-bash-prompt-suffix)
  - [`flake-registry`](/pages/nix-manual/command-ref/conf-file-prefix#conf-flake-registry)
  - [`commit-lock-file-summary`](/pages/nix-manual/command-ref/conf-file-prefix#conf-commit-lock-file-summary)
