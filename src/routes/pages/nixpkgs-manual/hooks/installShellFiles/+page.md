# <a id="installshellfiles"></a> `installShellFiles`
...
## <a id="installshellfiles-installbin"></a> `installBin`
...
### <a id="installshellfiles-installbin-exampleusage"></a> نمونه استفاده
...
## <a id="installshellfiles-installmanpage"></a> `installManPage`

تابع `installManPage` یک یا چند مسیر به صفحات راهنما (manpages) را برای نصب دریافت می‌کند.

صفحات راهنما باید دارای پسوند بخش باشند و به‌طور اختیاری می‌توانند فشرده‌شده باشند (با پسوند `.gz`). این تابع آن‌ها را در پوشهٔ صحیح `share/man/man&lt;section&gt;/` در [`outputMan`](#outputman) قرار می‌دهد.

### <a id="installshellfiles-installmanpage-exampleusage"></a> نمونه استفاده
...
اگر تجزیهٔ آرگومان‌ها مورد نظر نیست، برای انصراف از تمامی آرگومان‌های بعدی `--` را پاس دهید.
...
## <a id="installshellfiles-installshellcompletion"></a> `installShellCompletion`
...
### <a id="installshellfiles-installshellcompletion-exampleusage"></a> نمونه استفاده
...
### <a id="installshellfiles-installshellcompletion-exampleusage-guarded"></a> نمونه استفاده
