# <a id="chap-testers"></a> تست‌کننده‌ها

این فصل چند سازندهٔ آزمایش را توصیف می‌کند که در فضای نام `testers` در دسترس هستند.

## <a id="tester-hasPkgConfigModules"></a> `hasPkgConfigModules`

<a id="tester-hasPkgConfigModule"></a>
...
<a id="ex-haspkgconfigmodules-defaultvalues"></a>
...
<a id="ex-haspkgconfigmodules-explicitmodules"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="tester-hasCmakeConfigModules"></a> `hasCmakeConfigModules`
...
<a id="ex-hascmakeconfigmodules"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="tester-lycheeLinkCheck"></a> `lycheeLinkCheck`
...
### <a id="tester-lycheeLinkCheck-return"></a> مقدار بازگشتی
...
### <a id="tester-lycheeLinkCheck-inputs"></a> ورودی‌ها

`site` (مسیر یا derivation) <a id="tester-lycheeLinkCheck-param-site"></a>

: مسیر فایل‌ها برای بررسی.

`relocatable` (بولین، اختیاری) <a id="tester-lycheeLinkCheck-param-relocatable"></a>
...
`remap` (مجموعه ویژگی، اختیاری) <a id="tester-lycheeLinkCheck-param-remap"></a>
...
`extraConfig` (مجموعه صفت) <a id="tester-lycheeLinkCheck-param-extraConfig"></a>
...
`extraArgs` (لیست رشته‌ها، اختیاری) <a id="tester-lycheeLinkCheck-param-extraArgs"></a>
...
### <a id="tester-shellcheck-inputs"></a> ورودی‌ها
...
: نام تست.
  ...
  در صورت ارائه `name`، نام derivation تولیدشده توسط تست‌کننده برابر با `shellcheck-$`خواهد بود.`src` (از نوع مسیر)
...
### <a id="tester-shellcheck-return"></a> مقدار بازگشتی
...
### <a id="tester-shfmt-inputs"></a> ورودی‌ها

`name` (رشته)
: نام تست.
  `name` الزامی است زیرا قابلیت پیگیری شکست‌های تست را به شکل قابل توجهی بهبود می‌بخشد.
  نام derivation تولیدشده توسط این تست‌کننده `shfmt-$`است.`src` (مشابه مسیر / path-like)
...
### <a id="tester-shfmt-return"></a> مقدار بازگشتی
...
## <a id="tester-testVersion"></a> `testVersion`
...
<a id="ex-testversion-different-commandversion"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="tester-testBuildFailure"></a> `testBuildFailure`
...
<a id="ex-testBuildFailure-showingenvironmentchanges"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="tester-testBuildFailurePrime"></a> `testBuildFailure'`
...
<a id="ex-testBuildFailurePrime-doc-example"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
### <a id="tester-testBuildFailurePrime-inputs"></a> ورودی‌ها
...
### <a id="tester-testBuildFailurePrime-return"></a> مقدار بازگشتی
...
## <a id="tester-testEqualContents"></a> `testEqualContents`
...
<a id="ex-testEqualContents-toyexample"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="tester-testEqualArrayOrMap"></a> `testEqualArrayOrMap`
...
<a id="ex-testEqualArrayOrMap-test-function-add-cowbell"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
### <a id="tester-testEqualArrayOrMap-inputs"></a> ورودی‌ها
...
### <a id="tester-testEqualArrayOrMap-return"></a> مقدار بازگشتی
...
## <a id="tester-testEqualDerivation"></a> `testEqualDerivation`
...
<a id="ex-testEqualDerivation-hello"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="tester-invalidateFetcherByDrvHash"></a> `invalidateFetcherByDrvHash`
...
<a id="ex-invalidateFetcherByDrvHash-nix"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="tester-runCommand"></a> `runCommand`
...
<a id="ex-tester-runCommand-nix"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="tester-runNixOSTest"></a> `runNixOSTest`
...
## <a id="tester-nixosTest"></a> `nixosTest`
...
### <a id="tester-nixosTest-parameter"></a> پارامتر
...
### <a id="tester-nixosTest-result"></a> Result
...
## <a id="tester-modularServiceCompliance"></a> `modularServiceCompliance`
...
### <a id="tester-modularServiceCompliance-return"></a> Return value

یک مجموعه صفت (attribute set) از درایویشن‌ها که تست‌ها را در طول ساخت (Build) خود انجام می‌دهند.

### <a id="tester-modularServiceCompliance-inputs"></a> Inputs
...
<a id="ex-modularServiceCompliance-nixos"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
### <a id="tester-modularServiceCompliance-manual"></a> موارد انطباق دستی
