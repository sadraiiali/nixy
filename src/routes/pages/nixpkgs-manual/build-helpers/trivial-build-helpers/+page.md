# <a id="chap-trivial-builders"></a> کمک‌رسان‌های ساخت ساده
...
## <a id="trivial-builder-runCommandWith"></a> `runCommandWith`
...
### <a id="trivial-builder-runCommandWith-Type"></a> نوع
...
### <a id="trivial-builder-runCommandWith-Inputs"></a> ورودی‌ها
...
[allowSubstitutes]: /pages/nix-manual/language/advanced-attributes#adv-attr-allowSubstitutes
[preferLocalBuild]: /pages/nix-manual/language/advanced-attributes#adv-attr-preferLocalBuild
[substituter]: /pages/nix-manual/glossary#gloss-substituter
[substitutes]: /pages/nix-manual/glossary#gloss-substitute

<a id="ex-runcommandwith"></a>
...
## <a id="trivial-builder-runCommand"></a> `runCommand` و `runCommandCC`
...
### <a id="trivial-builder-runCommand-Type"></a> نوع
...
### <a id="trivial-builder-runCommand-Input"></a> ورودی
...
## <a id="trivial-builder-text-writing"></a> نوشتن فایل‌های متنی
...
### <a id="trivial-builder-makeDesktopItem"></a> `makeDesktopItem`
...
#### <a id="trivial-builder-makeDesktopItem-inputs"></a> ورودی‌ها
...
#### <a id="trivial-builder-makeDesktopItem-examples"></a> مثال‌ها

<a id="ex-makeDesktopItem"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
### <a id="trivial-builder-writeTextFile"></a> `writeTextFile`
...
### <a id="trivial-builder-writeText"></a> `writeText`
...
### <a id="trivial-builder-writeTextDir"></a> `writeTextDir`
...
### <a id="trivial-builder-writeScript"></a> `writeScript`
...
### <a id="trivial-builder-writeScriptBin"></a> `writeScriptBin`
...
### <a id="trivial-builder-writeShellScript"></a> `writeShellScript`
...
### <a id="trivial-builder-writeShellScriptBin"></a> `writeShellScriptBin`
...
## <a id="trivial-builder-concatText"></a> `concatTextFile`، `concatText`، `concatScript`
...
## <a id="trivial-builder-writeShellApplication"></a> `writeShellApplication`
...
## <a id="trivial-builder-symlinkJoin"></a> `symlinkJoin`
...
## <a id="trivial-builder-writeClosure"></a> `writeClosure`
...
## <a id="trivial-builder-writeDirectReferencesToFile"></a> `writeDirectReferencesToFile`
