# <a id="sec-make-disk-image"></a> `&lt;nixpkgs/nixos/lib/make-disk-image.nix&gt;`
...
## <a id="sec-make-disk-image-features"></a> ویژگی‌ها
...
### <a id="sec-make-disk-image-features-common"></a> عمومی
...
- نوع سیستم‌فایل ریشه (`fsType`) به هر آنچه که `mkfs.$`در طول عملیات موجود باشد قابل سفارشی‌سازی است
...
### <a id="sec-make-disk-image-features-full-image"></a> تصویر کامل NixOS
...
### <a id="sec-make-disk-image-features-reproducibility"></a> درباره بازتولیدپذیری بیت‌به‌بیت
...
## <a id="sec-make-disk-image-usage"></a> استفاده
