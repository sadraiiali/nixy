# <a id="sec-pkgs-dockerTools"></a> pkgs.dockerTools
...
## <a id="ssec-pkgs-dockerTools-buildImage"></a> buildImage
...
### <a id="ssec-pkgs-dockerTools-buildImage-inputs"></a> Inputs
...
### <a id="ssec-pkgs-dockerTools-buildImage-passthru-outputs"></a> خروجی‌های Passthru
...
### <a id="ssec-pkgs-dockerTools-buildImage-examples"></a> مثال‌ها
...
<a id="ex-dockerTools-buildImage-extraCommands"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-buildImage-creatednow"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="ssec-pkgs-dockerTools-buildLayeredImage"></a> buildLayeredImage
...
### <a id="ssec-pkgs-dockerTools-buildLayeredImage-examples"></a> نمونه‌ها

<a id="ex-dockerTools-buildLayeredImage-hello"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="ssec-pkgs-dockerTools-streamLayeredImage"></a> streamLayeredImage
...
### <a id="ssec-pkgs-dockerTools-streamLayeredImage-inputs"></a> Inputs
...
`contents` (مسیر یا فهرستی از مسیرها؛ _اختیاری_) <a id="dockerTools-buildLayeredImage-arg-contents"></a>
...
`config` (مجموعه ویژگی یا مقدار تهی؛ _اختیاری_) <a id="dockerTools-buildLayeredImage-arg-config"></a>
...
`uid` (عدد؛ _اختیاری_) <a id="dockerTools-buildLayeredImage-arg-uid"></a>
`gid` (عدد؛ _اختیاری_) <a id="dockerTools-buildLayeredImage-arg-gid"></a>
`uname` (رشته؛ _اختیاری_) <a id="dockerTools-buildLayeredImage-arg-uname"></a>
`gname` (رشته؛ _اختیاری_) <a id="dockerTools-buildLayeredImage-arg-gname"></a>
...
`maxLayers` (عدد؛ _اختیاری_) <a id="dockerTools-buildLayeredImage-arg-maxLayers"></a>
...
: یک اسکریپت Bash که در بافت لایه‌ی ایجادشده با محتویات مشخص‌شده توسط `contents` اجرا خواهد شد.
  ...
  پس از آن، وارد یک محیط `fakeroot(1)` می‌شود.
...
### <a id="ssec-pkgs-dockerTools-streamLayeredImage-passthru-outputs"></a> خروجی‌های Passthru
...
### <a id="ssec-pkgs-dockerTools-streamLayeredImage-examples"></a> مثال‌ها

<a id="ex-dockerTools-streamLayeredImage-hello"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-streamLayeredImage-exploringlayers"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-streamLayeredImage-configclosure"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ssec-pkgs-dockerTools-fetchFromRegistry"></a>
## <a id="ssec-pkgs-dockerTools-pullImage"></a> pullImage
...
### <a id="ssec-pkgs-dockerTools-pullImage-inputs"></a> ورودی‌ها
...
### <a id="ssec-pkgs-dockerTools-pullImage-examples"></a> نمونه‌ها

<a id="ex-dockerTools-pullImage-niximage"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-pullImage-differentregistry"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-pullImage-nixprefetchdocker"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="ssec-pkgs-dockerTools-exportImage"></a> exportImage
...
### <a id="ssec-pkgs-dockerTools-exportImage-inputs"></a> ورودی‌ها
...
### <a id="ssec-pkgs-dockerTools-exportImage-examples"></a> مثال‌ها

<a id="ex-dockerTools-exportImage-hello"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-exportImage-importingDocker"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-exportImage-naming"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-exportImage-fromImagePath"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="ssec-pkgs-dockerTools-helpers"></a> کمک‌رسان‌های محیط
...
برای جزئیات بیشتر درباره نحوه کارکرد آن، مستندات مربوط به تابعی را که استفاده می‌کنید ببینید.

### <a id="sssec-pkgs-dockerTools-helpers-usrBinEnv"></a> usrBinEnv
...
### <a id="sssec-pkgs-dockerTools-helpers-binSh"></a> binSh
...
### <a id="sssec-pkgs-dockerTools-helpers-caCertificates"></a> caCertificates
...
<a id="ssec-pkgs-dockerTools-fakeNss"></a>
### <a id="sssec-pkgs-dockerTools-helpers-fakeNss"></a> fakeNss

این یک صادرات مجدد (re-export) از بسته `fakeNss` در Nixpkgs است.
ببینید: [](#sec-fakeNss).

### <a id="ssec-pkgs-dockerTools-shadowSetup"></a> shadowSetup
...
`shadowSetup` به نتیجه‌ای مشابه [`fakeNss`](#sssec-pkgs-dockerTools-helpers-fakeNss) دست می‌یابد، اما علاوه بر راه‌اندازی فایل‌ها برای [PAM](https://en.wikipedia.org/wiki/Linux_PAM) و یک فایل `login.defs(5)`، فقط یک کاربر `root` با مقادیر متفاوت برای پوشه خانه و شل مورد استفاده تنظیم می‌کند.
...
### <a id="ssec-pkgs-dockerTools-helpers-examples"></a> نمونه‌ها

<a id="ex-dockerTools-helpers-buildImage"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-helpers-buildLayeredImage"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-shadowSetup-buildImage"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-shadowSetup-buildLayeredImage"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ssec-pkgs-dockerTools-buildNixShellImage-arguments"></a>
## <a id="ssec-pkgs-dockerTools-buildNixShellImage"></a> buildNixShellImage
...
<a id="ssec-pkgs-dockerTools-buildNixShellImage-example"></a>
### <a id="ssec-pkgs-dockerTools-buildNixShellImage-examples"></a> مثال‌ها

<a id="ex-dockerTools-buildNixShellImage-hello"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="ssec-pkgs-dockerTools-streamNixShellImage"></a> streamNixShellImage
...
### <a id="ssec-pkgs-dockerTools-streamNixShellImage-inputs"></a> Inputs
...
: مسیر باینری `bash` جهت استفاده به عنوان شل.
  ...
  این را می‌توان معادل [متغیر محیطی](https://nixos.org/manual/nix/stable/command-ref/nix-shell.html#environment-variables) `NIX_BUILD_SHELL` برای `nix-shell(1)` دانست.
...
: در صورت تعیین شدن، این دستور در محیط derivation در یک شل تعاملی اجرا خواهد شد.
  ...
  این را می‌توان معادل گزینه `--command` در `nix-shell(1)` دانست.
...
: مشابه صفت `command` است، اما در عوض دستور را در یک شل غیرتعاملی اجرا می‌کند.
  در صورت تعیین دستور، یک فراخوانی به `exit` پس از آن اضافه می‌شود تا شل پس از اتمام اجرا خارج شود.
  این را می‌توان معادل گزینه `--run` در `nix-shell(1)` دانست.

  _مقدار پیش‌فرض:_ `null`.

### <a id="ssec-pkgs-dockerTools-streamNixShellImage-examples"></a> مثال‌ها

<a id="ex-dockerTools-streamNixShellImage-hello"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-streamNixShellImage-extendingBuildInputs"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
<a id="ex-dockerTools-streamNixShellImage-addingShellHook"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
