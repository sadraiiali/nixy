...
## <a id="vm-tools-runInLinuxVM"></a> `vmTools.runInLinuxVM`
...
### <a id="vm-tools-runInLinuxVM-attributes"></a> صفات
...
### <a id="vm-tools-runInLinuxVM-examples"></a> نمونه‌ها
...
### <a id="vm-tools-extractFs-examples"></a> نمونه‌ها
...
## <a id="vm-tools-extractMTDfs"></a> `vmTools.extractMTDfs`
...
## <a id="vm-tools-runInLinuxImage"></a> `vmTools.runInLinuxImage`
...
## <a id="vm-tools-makeImageTestScript"></a> `vmTools.makeImageTestScript`

تولید یک اسکریپت که می‌تواند برای اجرای یک نشست تعاملی در تصویر داده‌شده استفاده شود.

### <a id="vm-tools-makeImageTestScript-examples"></a> Examples
...
## <a id="vm-tools-diskImageFuns"></a> `vmTools.diskImageFuns`

مجموعه‌ای از توابع که مجموعه‌ای از‌پیش‌تعریف‌شده از تصاویر مینیمال توزیع‌های Linux را می‌سازند.

### <a id="vm-tools-diskImageFuns-images"></a> تصاویر
...
### <a id="vm-tools-diskImageFuns-attributes"></a> صفات
...
### <a id="vm-tools-diskImageFuns-examples"></a> مثال‌ها
...
## <a id="vm-tools-diskImageExtraFuns"></a> `vmTools.diskImageExtraFuns`

میانبری برای `vmTools.diskImageFuns.&lt;attr&gt; {'{'}'{'{'}'{'}'} extraPackages = ... {'{'}'{'}'}'{'}'}`.

## <a id="vm-tools-diskImages"></a> `vmTools.diskImages`
