# <a id="part-builders"></a> کمک‌رسان‌های ساخت
...
- [آرگومان‌های نقطه ثابت کمک‌رسان‌های ساخت](/pages/nixpkgs-manual/build-helpers/fixed-point-arguments)
- [دریافت‌کننده‌ها](/pages/nixpkgs-manual/build-helpers/fetchers)
- [کمک‌رسان‌های ساخت ساده](/pages/nixpkgs-manual/build-helpers/trivial-build-helpers)
- [تست‌کننده‌ها](/pages/nixpkgs-manual/build-helpers/testers)
- [ابزارهای کمکی شل توسعه](/pages/nixpkgs-manual/build-helpers/dev-shell-tools)
- [کمک‌رسان‌های ساخت ویژه](/pages/nixpkgs-manual/build-helpers/special)
- [تصاویر](/pages/nixpkgs-manual/build-helpers/images)
- [مرجع قلاب‌ها](/pages/nixpkgs-manual/hooks)
- [بسته‌ها](/pages/nixpkgs-manual/packages)
