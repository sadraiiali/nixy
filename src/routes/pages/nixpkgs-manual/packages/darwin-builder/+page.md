# <a id="sec-darwin-builder"></a> darwin.linux-builder
...
>
> ## <a id="sec-darwin-builder-example-flake"></a> نمونه استفاده از فلیک
>
...
> ```
>
> ## <a id="sec-darwin-builder-reconfiguring"></a> پیکربندی مجدد سازنده راه دور
>
...
>
> ## <a id="sec-darwin-builder-troubleshoot"></a> عیب‌یابی پیکربندی ایجادشده
>
