# <a id="cataclysm-dark-days-ahead"></a> Cataclysm: Dark Days Ahead

## <a id="how-to-install-cataclysm-dda"></a> نحوه نصب Cataclysm DDA
...
## <a id="important-note-for-overriding-packages"></a> نکته مهم برای بازنشانی بسته‌ها
...
## <a id="customizing-with-mods"></a> سفارشی‌سازی با مودها
...
همهٔ مادها، بسته‌های صوتی و تایلت‌سِت‌های موجود در Nixpkgs در `cataclysmDDA.pkgs` یافت می‌شوند.
