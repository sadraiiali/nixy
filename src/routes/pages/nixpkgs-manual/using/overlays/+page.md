...
## <a id="sec-overlays-definition"></a> Defining overlays
## <a id="sec-overlays-definition"></a> تعریف اورلای‌ها
...
### <a id="sec-overlays-alternatives-mpi"></a> تعویض پیاده‌سازی MPI
