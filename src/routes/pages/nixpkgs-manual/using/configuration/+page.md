# <a id="chap-packageconfig"></a> پیکربندی سراسری

Nix بر اساس متاداده‌های یک بسته، دارای پیش‌فرض‌های مشخصی درباره این است که کدام بسته‌ها می‌توانند یا نمی‌توانند نصب شوند.
...
>
>
> ## <a id="sec-allow-unsupported-system"></a> نصب بسته‌ها روی سیستم‌های پشتیبانی‌نشده
>
...
> ```
>
> ## <a id="sec-config-options-reference"></a> مرجع گزینه‌های `config`
>
...
>
>
> ## <a id="sec-declarative-package-management"></a> مدیریت اعلانی بسته‌ها
>
> ### <a id="sec-building-environment"></a> ساخت یک محیط
>
...
>
> ### <a id="sec-gnu-info-setup"></a> راه‌اندازی GNU info
>
