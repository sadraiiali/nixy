# <a id="sec-language-dart"></a> Dart

## <a id="ssec-dart-applications"></a> برنامه‌های Dart
...
### <a id="ssec-dart-applications-patching-dependencies"></a> پچ کردن وابستگی‌ها
...
### <a id="ssec-dart-applications-build-tools"></a> اجرای برنامه‌های اجرایی از dev_dependencies
...
### <a id="ssec-dart-applications-nix-shell"></a> استفاده با nix-shell

#### <a id="ssec-dart-applications-nix-shell-deps"></a> استفاده از وابستگی‌ها از انبار نیکس (Nix store)
...
## <a id="ssec-dart-flutter"></a> برنامه‌های Flutter
...
`flutter` در Nixpkgs همیشه به `flutterPackages.stable` اشاره دارد که آخرین نسخهٔ بسته‌بندی‌شده است. برای جلوگیری از خرابی‌های پیش‌بینی‌نشده در زمان ارتقا، بسته‌ها در Nixpkgs باید به جای استفاده مستقیم از `flutter`، از نسخهٔ مشخصی از flutter مانند `flutter335` و `flutter338` استفاده کنند.
...
### <a id="ssec-dart-flutter-nix-shell"></a> استفاده به همراه nix-shell
...
#### <a id="ssec-dart-flutter-nix-shell-enter"></a> ورود به شل
