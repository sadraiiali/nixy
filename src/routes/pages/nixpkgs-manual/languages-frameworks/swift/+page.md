...
### <a id="ssec-swiftpm-custom-build-flags"></a> پرچم‌های ساخت سفارشی
...
### <a id="ssec-swiftpm-patching-dependencies"></a> پچ کردن وابستگی‌ها
...
## <a id="ssec-swift-considerations-for-custom-build-tools"></a> ملاحظات برای ابزارهای ساخت سفارشی

### <a id="ssec-swift-linking-the-standard-library"></a> پیوند دادن کتابخانه استاندارد
