...
## <a id="haskell-mkderivation"></a> `haskellPackages.mkDerivation`
...
## <a id="haskell-development-environments"></a> محیط‌های توسعه
...
```
جایی که تمام رشته‌های `version` مجاز هستند، به طوری که `haskell.packages.ghc$`یک مجموعه بسته‌ی موجود باشد.
