...
## <a id="lua-userguide"></a> استفاده از Lua

### <a id="lua-overview"></a> نگاهی کلی به Lua
...
#### <a id="lua-environment-defined-in-.confignixpkgsconfig.nix"></a> محیط Lua تعریف‌شده در `~/.config/nixpkgs/config.nix`
...
#### <a id="lua-environment-defined-in-etcnixosconfiguration.nix"></a> محیط Lua تعریف‌شده در `/etc/nixos/configuration.nix`
...
### <a id="how-to-override-a-lua-package-using-overlays"></a> چگونه یک بسته Lua را با استفاده از اورلی‌ها بازنشانی کنیم؟
...
### <a id="temporary-lua-environment-with-nix-shell"></a> محیط موقت Lua با `nix-shell`
...
مفسر Lua دارای صفت `pkgs` است که تمام کتابخانه‌های Lua را برای آن مفسر خاص در بر دارد.

## <a id="lua-developing"></a> توسعه با Lua
...
### <a id="packaging-a-library-on-luarocks"></a> بسته‌بندی یک کتابخانه در luarocks
...
### <a id="lua-contributing"></a> راهنمای مشارکت در Lua
