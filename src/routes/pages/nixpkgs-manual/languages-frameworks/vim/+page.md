...
>
>
> ## <a id="managing-plugins-with-vim-packages"></a> مدیریت پلاگین‌ها با بسته‌های Vim
>
...
>
> ## <a id="managing-plugins-with-vim-plug"></a> مدیریت پلاگین‌ها با vim-plug
>
...
>
> ## <a id="vim-out-of-tree-overlays"></a> چگونه یک اورلی خارج از درخت (out-of-tree) از افزونه‌های vim را نگهداری کنیم؟
>
