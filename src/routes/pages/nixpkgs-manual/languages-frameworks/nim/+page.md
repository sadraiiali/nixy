...
## <a id="buildNimPackage"></a> buildNimPackage
...
### <a id="buildnimpackage-parameters"></a> پارامترهای `buildNimPackage`
...
## <a id="buildNimSbom"></a> buildNimSbom
...
### <a id="generating-nim-sboms"></a> تولید SBOMها
...
## <a id="nim-lock-overrides"></a> بازنشانی‌های وابستگی lockfile
