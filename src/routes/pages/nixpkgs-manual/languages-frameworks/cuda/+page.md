...
## <a id="cuda-user-guide"></a> راهنمای کاربر
...
### <a id="cuda-configuring-nixpkgs-for-cuda"></a> پیکربندی Nixpkgs برای CUDA
...
### <a id="cuda-modifying-cuda-package-sets"></a> تغییر مجموعه‌های بسته CUDA
...
### <a id="cuda-extending-cuda-package-sets"></a> گسترش مجموعه‌های بسته CUDA
...
### <a id="cuda-using-cudapackages"></a> استفاده از `cudaPackages`
...
### <a id="cuda-nixpkgs-cuda-variants"></a> گونه‌های CUDA در Nixpkgs
...
#### <a id="cuda-using-cudapackages-pkgs"></a> استفاده از `cudaPackages.pkgs`
...
#### <a id="cuda-using-pkgscuda"></a> استفاده از `pkgsCuda`
...
#### <a id="cuda-using-pkgsforcudaarch"></a> استفاده از `pkgsForCudaArch`
...
### <a id="cuda-docker-podman"></a> اجرای کانتینرهای Docker یا Podman با پشتیبانی از CUDA
...
#### <a id="cuda-specifying-what-devices-to-expose-to-the-container"></a> مشخص کردن دستگاه‌های قابل دسترس برای کنتینر
...
#### <a id="cuda-using-docker-compose"></a> استفاده از docker-compose
...
## <a id="cuda-contributing"></a> مشارکت
...
### <a id="cuda-package-set-maintenance"></a> نگهداری مجموعه‌ی بسته‌ها
...
#### <a id="cuda-updating-redistributables"></a> به‌روزرسانی توزیع‌پذیرها
...
#### <a id="cuda-updating-supported-compilers-and-gpus"></a> به‌روزرسانی کامپایلرها و پردازنده‌های گرافیکی پشتیبانی‌شده
...
#### <a id="cuda-updating-the-cuda-package-set"></a> به‌روزرسانی مجموعه‌ی بسته‌های CUDA
...
### <a id="cuda-writing-tests"></a> نوشتن تست‌ها
...
#### <a id="cuda-passthru-testers"></a> `passthru.testers`
...
#### <a id="cuda-passthru-tests"></a> `passthru.tests`
