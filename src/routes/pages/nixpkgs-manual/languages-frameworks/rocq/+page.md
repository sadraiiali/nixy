# <a id="sec-language-rocq"></a> Rocq و بسته‌های rocq
...
## <a id="rocq-packages-attribute-sets-rocqpackages"></a> مجموعه‌های ویژگی بسته‌های Rocq: `rocqPackages`
...
## <a id="rocq-overriding-packages"></a> سه روش برای بازنشانی بسته‌های Rocq
...
### <a id="rocq-overrideRocqDerivation"></a> `overrideRocqDerivation`
...
### <a id="rocq-overrideAttrs"></a> `.overrideAttrs`
