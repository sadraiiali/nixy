# <a id="sec-language-ruby"></a> Ruby

## <a id="using-ruby"></a> استفاده از Ruby
...
#### <a id="using-nix-shell-as-shebang"></a> استفاده از `nix-shell` به عنوان شیبنگ
...
## <a id="developing-with-ruby"></a> توسعه با Ruby

### <a id="using-an-existing-gemfile"></a> استفاده از یک Gemfile موجود
...
### <a id="gem-specific-configurations-and-workarounds"></a> پیکربندی‌ها و راهکارهای مختص Gem
...
### <a id="ruby-platform-specif-gems"></a> Gemهای مخصوص پلتفرم
...
### <a id="adding-a-gem-to-the-default-gemset"></a> افزودن یک gem به gemset پیش‌فرض
