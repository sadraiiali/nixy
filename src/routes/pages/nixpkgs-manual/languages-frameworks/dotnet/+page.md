# <a id="dotnet"></a> Dotnet

## <a id="local-development-workflow"></a> گردش کار توسعه محلی
...
### <a id="using-many-sdks-in-a-workflow"></a> استفاده از چند SDK در یک گردش کار
...
## <a id="dotnet-sdk-vs-dotnetcorepackages.sdk"></a> dotnet-sdk در برابر dotnetCorePackages.sdk
...
## <a id="dotnetcorepackages.sdk-vs-dotnetcorepackages.runtime-vs-dotnetcorepackages.aspnetcore"></a> dotnetCorePackages.sdk در برابر dotnetCorePackages.runtime در برابر dotnetCorePackages.aspnetcore
...
## <a id="packaging-a-dotnet-application"></a> بسته‌بندی یک برنامه Dotnet
...
## <a id="dotnet-global-tools"></a> ابزارهای جهانی Dotnet
...
### <a id="packaging-dotnet-global-tools"></a> بسته‌بندی ابزارهای جهانی Dotnet
...
```
## <a id="generating-and-updating-nuget-dependencies"></a> تولید و به‌روزرسانی وابستگی‌های NuGet
