...
## <a id="installing-idris"></a> نصب Idris
...
## <a id="starting-idris-with-library-support"></a> راه‌اندازی Idris با پشتیبانی از کتابخانه‌ها
...
## <a id="building-an-idris-project-with-nix"></a> ساخت یک پروژه Idris با Nix
...
## <a id="passing-options-to-idris-commands"></a> ارسال گزینه‌ها به دستورات `idris`
