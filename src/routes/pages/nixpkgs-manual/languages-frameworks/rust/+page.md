...
### <a id="importing-a-cargo.lock-file"></a> درون‌ریزی یک فایل `Cargo.lock`
...
### <a id="cargo-features"></a> ویژگی‌های Cargo
...
### <a id="cross-compilation"></a> کامپایل متقاطع
...
### <a id="running-package-tests"></a> اجرای تست‌های بسته
...
#### <a id="using-cargo-nextest"></a> استفاده از `cargo-nextest`
...
#### <a id="setting-test-threads"></a> تنظیم `test-threads`
...
### <a id="building-a-package-in-debug-mode"></a> ساخت یک بسته در حالت `debug`
...
### <a id="custom-buildinstall-procedures"></a> روال‌های سفارشی `build`/`install`
...
### <a id="compiling-non-rust-packages-that-include-rust-code"></a> کامپایل کردن بسته‌های غیر Rust که شامل کد Rust هستند
...
#### <a id="vendoring-of-dependencies"></a> تأمین محلی (Vendoring) وابستگی‌ها
...
#### <a id="python-package-using-maturin"></a> بسته‌ی Python با استفاده از `maturin`
...
#### <a id="rust-package-built-with-meson"></a> بسته Rust ساخته‌شده با `meson`
...
### <a id="compiling-wasm32-wasip1-package"></a> کامپایل بستهٔ `wasm32-wasip1`
...
## <a id="compiling-rust-crates-using-nix-instead-of-cargo"></a> `buildRustCrate`: کامپایل کردن کریت‌های Rust با استفاده از Nix به جای Cargo

### <a id="simple-operation"></a> عملکرد ساده
...
### <a id="options-and-phases-configuration"></a> پیکربندی گزینه‌ها و فازها
...
### <a id="setting-up-nix-shell"></a> راه‌اندازی `nix-shell`
...
## <a id="using-community-maintained-rust-toolchains"></a> استفاده از زنجیره‌ابزارهای Rust نگه‌داری‌شده توسط جامعهٔ کاربری
