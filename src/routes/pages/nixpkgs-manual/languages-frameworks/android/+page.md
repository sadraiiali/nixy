...
## <a id="using-androidenv-with-android-studio"></a> استفاده از androidenv با Android Studio
...
## <a id="deploying-an-android-sdk-installation-with-plugins"></a> استقرار یک نصب Android SDK به همراه افزونه‌ها
...
## <a id="using-predefined-android-package-compositions"></a> استفاده از ترکیب‌های از‌پیش‌تعریف‌شده بسته‌های Android
...
## <a id="spawning-emulator-instances"></a> ایجاد نمونه‌های شبیه‌ساز
...
## <a id="notes-on-environment-variables-in-android-projects"></a> نکاتی درباره متغیرهای محیطی در پروژه‌های Android
...
## <a id="notes-on-improving-build.gradle-compatibility"></a> نکاتی در مورد بهبود سازگاری build.gradle
...
## <a id="querying-the-available-versions-of-each-plugin"></a> استعلام نسخه‌های موجود برای هر پلاگین
...
## <a id="updating-the-generated-expressions"></a> به‌روزرسانی عبارت‌های تولیدشده
...
## <a id="building-an-android-application-with-ant"></a> ساخت یک برنامه Android با Ant
