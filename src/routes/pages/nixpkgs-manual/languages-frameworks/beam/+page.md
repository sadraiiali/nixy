# <a id="sec-beam"></a> زبان‌های BEAM (Erlang، Elixir و LFE)

## <a id="beam-introduction"></a> مقدمه
...
## <a id="available-versions-and-deprecations-schedule"></a> نسخه‌های موجود و جدول زمان‌بندی منسوخ‌سازی

### <a id="erlang"></a> Erlang OTP
...
## <a id="beam-build-tools"></a> ابزارهای ساخت

### <a id="beam-build-tools-rebar3"></a> Rebar3
...
### <a id="beam-build-tools-erlangmk"></a> Erlang.mk
...
### <a id="beam-build-tools-mix"></a> Mix
...
## <a id="how-to-install-beam-packages"></a> نحوه نصب بسته‌های BEAM
...
<a id="ex-beam-ephemeral-shell"></a>
...
<a id="ex-beam-declarative-shell"></a>
> <span class="admonition-kind" data-kind="example"></span>
>
> **مثال**
>
...
## <a id="packaging-beam-applications"></a> بسته‌بندی برنامه‌های BEAM

### <a id="packaging-erlang-applications"></a> برنامه‌های Erlang

#### <a id="rebar3-packages"></a> بسته‌های Rebar3
...
#### <a id="erlang-mk-packages"></a> بسته‌های Erlang.mk
...
### <a id="packaging-elixir-applications"></a> برنامه‌های Elixir

#### <a id="mix-packages"></a> بسته‌های Mix
...
#### <a id="mix-release-elixir-phoenix-example"></a> mixRelease - نمونه Elixir Phoenix
...
##### <a id="mix-release-javascript-deps"></a> mixRelease - وابستگی‌های فرانت‌اند (جاوااسکریپت)
...
##### <a id="mix-release-mix-deps"></a> mixRelease - وابستگی‌های بک‌اند (mix)
...
##### <a id="fixed-output-derivation"></a> FOD
...
##### <a id="mix-release-example"></a> mixRelease - مثال
...
#### <a id="example-of-creating-a-service-for-an-elixir---phoenix-project"></a> نمونه‌ای از ایجاد یک سرویس برای یک پروژه Elixir - Phoenix
...
## <a id="how-to-develop"></a> نحوه توسعه

### <a id="creating-a-shell"></a> ایجاد یک شل
...
### <a id="beam-using-overlays"></a> استفاده از یک اورلی
...
#### <a id="beam-using-overlays-shell.nix"></a> `shell.nix`
...
#### <a id="elixir---phoenix-project"></a> پروژه Elixir - Phoenix
