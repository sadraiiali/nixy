# <a id="sec-language-go"></a> Go

## <a id="ssec-language-go"></a> ساخت ماژول‌های Go با `buildGoModule`
...
## <a id="buildgomodule-parameters"></a> صفات `buildGoModule`
...
### <a id="var-go-proxyVendor"></a> `proxyVendor`
...
### <a id="var-go-deleteVendor"></a> `deleteVendor`
...
### <a id="var-go-subPackages"></a> `subPackages`
...
### <a id="var-go-excludedPackages"></a> `excludedPackages`
...
### <a id="var-go-enableParallelBuilding"></a> `enableParallelBuilding`
...
## <a id="ssec-skip-go-tests"></a> صرف‌نظر کردن از تست‌ها
...
## <a id="buildGoPackage-migration"></a> مهاجرت از `buildGoPackage` به `buildGoModule`
