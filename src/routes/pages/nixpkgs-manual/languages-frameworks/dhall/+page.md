# <a id="sec-language-dhall"></a> Dhall
...
## <a id="ssec-dhall-remote-imports"></a> درون‌ریزی‌های راه دور
...
## <a id="ssec-dhall-packaging-expression"></a> بسته‌بندی یک عبارت Dhall از صفر
...
## <a id="ssec-dhall-package-contents"></a> محتویات یک بسته Dhall
...
## <a id="ssec-dhall-packaging-functions"></a> توابع بسته‌بندی
...
## <a id="ssec-dhall-dhall-to-nixpkgs"></a> `dhall-to-nixpkgs`
...
### <a id="ssec-dhall-remote-imports-as-fod"></a> درون‌ریزی‌های راه دور به عنوان درایویشن‌های با خروجی ثابت
...
## <a id="ssec-dhall-overriding-dependency-versions"></a> بازنشانی نسخه‌های وابستگی
...
## <a id="ssec-dhall-overrides"></a> بازنشانی‌ها
