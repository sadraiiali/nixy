# <a id="sec-language-perl"></a> Perl

## <a id="ssec-perl-running"></a> اجرای برنامه‌های Perl در شل
...
## <a id="ssec-perl-packaging"></a> بسته‌بندی برنامه‌های Perl
...
### <a id="ssec-generation-from-CPAN"></a> تولید از CPAN
