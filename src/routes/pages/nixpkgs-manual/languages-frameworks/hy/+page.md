# <a id="sec-language-hy"></a> Hy

## <a id="ssec-hy-installation"></a> نصب

### <a id="installation-without-packages"></a> نصب بدون بسته‌ها
...
### <a id="installation-with-packages"></a> نصب همراه با بسته‌ها
