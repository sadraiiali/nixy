...
از آنجا که برنامه‌نویسی در Nix سراسر درباره‌ی `attribute sets` است، مهم است
...
* هر تمرین `ex00, ex01, ...` باید به همان مقداری ارزیابی شود که با آن مقایسه شده است، کافی است پس از زدن دکمه‌ی «run» خروجی را ببینید.
