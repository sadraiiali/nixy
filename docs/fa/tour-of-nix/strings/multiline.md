...
دربارهٔ مدیریت رشته در Nix حتماً <https://nixos.org/manual/nix/stable/language/values> را مطالعه کنید!

بنابراین حالا:

 * قالب ex0 را مطابق آنچه بررسی‌کنندهٔ راه‌حل درخواست می‌کند، تنظیم کنید!

**نکته:** کمی با عمق توررفتگی فاصله (space) بازی کنید و ببینید چه تغییری روی رشتهٔ تولیدشده اعمال می‌کند.
