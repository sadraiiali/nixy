...
بسته‌های Nix می‌توانند *صفات متاداده* را اظهار کنند که حاوی اطلاعاتی دربارهٔ یک بسته مانند توضیحات، صفحه خانگی،
...
یک صفت (attribute) فقط‌خواندنی شامل فهرستی از حدس‌ها دربارهٔ این‌که CPE برای این بسته چگونه می‌تواند باشد. این صفت شامل تمامی گونه‌های مدیریت نسخه اشاره‌شده در بالا است. هر عنصر یک attrset با صفات `cpeParts` و `
