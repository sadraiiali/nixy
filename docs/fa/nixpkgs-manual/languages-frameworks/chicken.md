...
## استفاده از Eggs {#sec-chicken-using}
...
## به‌روزرسانی ایگ‌ها {#sec-chicken-updating-eggs}
...
## افزودن eggها {#sec-chicken-adding-eggs}
...
## اسکوپ بازنشانی {#sec-chicken-override-scope}
