...
## درباره‌ی قلاب‌های `wrapGApps*` {#ssec-gnome-hooks}
...
- خود قلاب `wrapGApps*` پوشه‌ی `share` مربوط به بسته را به `XDG_DATA_DIRS` اضافه می‌کند.
...
در مورد یک برنامه‌ی پایتون، این کار می‌تواند به شکل زیر باشد:
