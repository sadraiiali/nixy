...
## محیط سفارشی {#typst-custom-environment}
...
### مدیریت هش‌های قدیمی بسته {#typst-handling-outdated-package-hashes}
...
## بسته‌های سفارشی {#typst-custom-packages}
...
### حوزه و نحوه استفاده از بسته {#typst-package-scope-and-usage}
...
از سوی دیگر، **بسته‌های محلی** (بسته‌هایی که تحت حوزه‌ی `@local` قرار دارند)، بخشی از محیط Typst محسوب **نمی‌شوند**. این بدان معناست که بسته‌های محلی در صورت نیاز باید به‌صورت دستی به کامپایلر Typst پیوند داده شوند.
