...
اولین ساخت خطایی دربارهٔ مقدار هش خواهد داد، پس از آن می‌توانید آن را با مقدار پیشنهادی جایگزین کنید.
...
معمولاً، ما نیاز داریم یک فایل `shell.nix` ایجاد کنیم و توسعهٔ خود را داخل محیط مشخص‌شده در آن انجام دهیم. کافی است نسخه Erlang خود و هر مفسر دیگری را نصب کنید، و سپس از ابزارهای ساخت معمولی خود استفاده کنید. به عنوان مثال، با Elixir:
