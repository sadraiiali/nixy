...
## درون‌ریزی بسته‌ها از Quicklisp {#lisp-importing-packages-from-quicklisp}
...
Translation:
## تعریف دستی بسته‌ها در خارج از Nixpkgs {#lisp-defining-packages-outside}
...
## بازنشانی صفات بسته {#lisp-overriding-package-attributes}
...
### مدیریت سیستم‌های اسلش‌دار {#lisp-dealing-with-slashy-systems}
...
### بارگیری ASDF {#lisp-loading-asdf}
