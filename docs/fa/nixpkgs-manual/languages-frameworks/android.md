...
همچنین می‌توانید SDK را به‌طور جداگانه با مجموعه‌ی دلخواهی از افزونه‌ها یا زیرمجموعه‌هایی از یک SDK استقرار دهید.
...
## نکاتی درباره‌ی متغیرهای محیطی در پروژه‌های Android {#notes-on-environment-variables-in-android-projects}
...
این تابع ساخت به‌ویژه زمانی مفید است که قصد داشته باشید از [Hydra](https://nixos.org/hydra) استفاده کنید: راهکار ادغام مداوم (CI) مبتنی بر Nix برای ساخت برنامه‌های Android. یک Android APK به عنوان یک فرآورده‌ی ساخت ارائه می‌شود و می‌توان آن را با رفتن به صفحه‌ی نتیجه‌ی ساخت، روی هر دستگاه Android دارای مرورگر وب نصب کرد.
