...
در ابتدا نباید پیکربندی سازنده راه دور را تغییر دهید، در غیر این صورت قادر به استفاده از کش باینری نخواهید بود. با این حال، پس از اینکه سازنده راه دور را به صورت محلی در حال اجرا داشتید، می‌توانید از آن برای ساخت یک سازنده راه دور تغییریافته با فضای ذخیره‌سازی یا حافظه‌ی اضافی استفاده کنید.
