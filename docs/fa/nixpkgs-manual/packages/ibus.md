...
## فعال‌سازی موتور {#sec-ibus-typing-booster-activate}
...
## استفاده از دیکشنری‌های سفارشی hunspell {#sec-ibus-typing-booster-customize-hunspell}
...
## انتخاب‌کننده ایموجی توکار {#sec-ibus-typing-booster-emoji-picker}
