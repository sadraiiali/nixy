...
متغیرهای صادرشده:
 ...
 - `PGHOST`: مکان پوشهٔ سوکت دامنهٔ یونیکس؛ `host` پیش‌فرض در یک رشتهٔ اتصال (connection string).
...
راهکار ترجیحی این است که مجموعه تست را مجبور کنید از اتصال سوکت دامنهٔ یونیکس استفاده کند. این رفتار پیش‌فرض در زمانی است که هیچ پارامتر اتصال `host` ارائه نشده باشد.
