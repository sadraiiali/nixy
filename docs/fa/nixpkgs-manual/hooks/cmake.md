...
## متغیرهای کنترل‌کننده CMake {#cmake-variables-controlling}

### متغیرهای اختصاصی CMake {#cmake-exclusive-variables}
...
## کنترل فراخوانی CTest {#cmake-ctest}
...
### متغیرهای CTest {#cmake-ctest-variables}
