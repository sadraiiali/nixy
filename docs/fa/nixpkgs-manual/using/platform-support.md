# پشتیبانی از پلتفرم {#chap-platform-support}
...
## سطح‌ها {#sec-platform-tiers}

### سطح ۱ {#sec-platform-tier1}
...
### سطح ۴ تا ۷ {#sec-platform-tier4-7}
