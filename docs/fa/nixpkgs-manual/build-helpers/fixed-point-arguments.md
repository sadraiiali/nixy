# آرگومان‌های نقطه ثابت کمک‌رسان‌های ساخت {#chap-build-helpers-finalAttrs}
...
برای سازوکار زیرین، [مجموعه‌های بازگشتی](https://nix.dev/manual/nix/stable/language/syntax#recursive-sets) را ببینید.

## تعریف یک کمک‌رسان ساخت با `lib.extendMkDerivation` {#sec-build-helper-extendMkDerivation}
