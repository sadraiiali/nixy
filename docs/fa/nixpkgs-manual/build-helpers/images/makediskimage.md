...
- با استفاده از `cptofs` بدون هیچ ماشین مجازی برای ایجاد یک تصویر دیسک انبار Nix، با استفاده از یک ماشین مجازی برای ایجاد یک نصب کامل NixOS.
...
### درباره‌ی بازتولیدپذیری بیت‌به‌بیت {#sec-make-disk-image-features-reproducibility}
