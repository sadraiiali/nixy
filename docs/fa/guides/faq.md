...
لطفاً [](packaging-tutorial) را مطالعه کنید.

### چگونه از یک کلون از مخزن Nixpkgs برای به‌روزرسانی یا نوشتن بسته‌های جدید استفاده کنیم؟

لطفاً [](packaging-tutorial) و [راهنمای مشارکت Nixpkgs](https://github.com/NixOS/nixpkgs/blob/master/CONTRIBUTING.md) را مطالعه کنید.
...
- یک عبارت Nix برای برنامه بنویسید تا آن را در پیکربندی خودتان بسته‌بندی کنید.
  ...
  - ساخت از روی کد منبع.
    ...
    برای آشنایی با این موضوع، [](packaging-tutorial) را ببینید.
