...
اگر نتایج متعددی وجود داشته باشد، با شماره‌گذاری ترتیبی پیوند‌های نمادین (symlink) فراتر از مورد اول، چندین پیوند نمادین (symlink) ایجاد خواهد شد (به عنوان مثال، `foo`، `foo-2`، `foo-3` و غیره).
