...
عملیات `--read-log` گزارش ساخت مسیرهای انبار مشخص‌شده را روی خروجی استاندارد چاپ می‌کند. گزارش ساخت هر چیزی است که سازنده‌ی یک derivation روی خروجی استاندارد و خطای استاندارد نوشته‌است. اگر یک مسیر انبار یک derivation نباشد، سازنده‌ی آن مسیر انبار مورد استفاده قرار می‌گیرد.
