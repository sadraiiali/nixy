...
`nix-store --query` - نمایش اطلاعات درباره‌ی مسیرهای انبار
...
عملیات `--query` اطلاعات مختلفی را درباره‌ی مسیرهای انبار نمایش می‌دهد. پرس‌وجوها در ادامه شرح داده شده‌اند. حداکثر یک پرس‌وجو را می‌توان مشخص کرد. پرس‌وجوی پیش‌فرض `--outputs` است.
