# nix flake - Nix 2.34.9 Reference Manual

> Source: [https://nix.dev/manual/nix/stable/command-ref/new-cli/nix3-flake.html](@docroot@/command-ref/new-cli/nix3-flake.md)
...
- [`nix flake archive`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-archive) - copy a flake and all its inputs to a store
- [`nix flake check`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-check) - check whether the flake evaluates and run its tests
- [`nix flake clone`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-clone) - clone flake repository
- [`nix flake info`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-info) - show flake metadata
- [`nix flake init`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-init) - create a flake in the current directory from a template
- [`nix flake lock`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-lock) - create missing lock file entries
- [`nix flake metadata`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-metadata) - show flake metadata
- [`nix flake new`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-new) - create a flake in the specified directory from a template
- [`nix flake prefetch`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-prefetch) - download the source tree denoted by a flake reference into the Nix store
- [`nix flake prefetch-inputs`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-prefetch-inputs) - fetch the inputs of a flake
- [`nix flake show`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-show) - show the outputs provided by a flake
- [`nix flake update`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake-update) - update flake lock file
...
# <a id="flake-references"></a> Flake references

Flake references (*flakerefs*) are a way to specify the location of a
flake. These have two different forms:

## <a id="attribute-set-representation"></a> Attribute set representation
...
## <a id="url-like-syntax"></a> URL-like syntax
...
## <a id="path-like-syntax"></a> Path-like syntax
...
## <a id="flake-reference-attributes"></a> Flake reference attributes
...
[Nix Archive (NAR) serialisation](https://nix.dev/manual/nix/2.34/store/file-system-object/content-address#serial-nix-archive)
...
that are looked up in [the flake registries](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-registry).
These have the form
...
entry in the registry; see [nix registry](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-registry) for
details.
...
- <a id="path-fetcher"></a>[https://nix.dev/manual/nix/stable/command-ref/new-cli/nix3-flake.html](@docroot@/command-ref/new-cli/nix3-flake.md)`path`: arbitrary local directories. The required attribute `path`
...
Note that the allowed syntax for path values in flake `inputs` may be more restrictive than general Nix, so you may need to use `path:` if your path contains certain special characters. See [Path literals](https://nix.dev/manual/nix/2.34/language/syntax#path-literal)
...
can be dropped.
This can also be used to set the location of gitea/forgejo branches. [See here](https://nix.dev/manual/nix/2.34/protocols/tarball-fetcher#gitea-and-forgejo-support)
...
# <a id="flake-format"></a> Flake format

As an example, here is a simple `flake.nix` that depends on the
Nixpkgs flake and provides a single package (i.e. an
[installable](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix#installables) derivation):
...
set of options is allowed to be set without confirmation so long as [`accept-flake-config`](https://nix.dev/manual/nix/2.34/command-ref/conf-file#conf-accept-flake-config) is not enabled in the global configuration:
  - [`bash-prompt`](https://nix.dev/manual/nix/2.34/command-ref/conf-file#conf-bash-prompt)
  - [`bash-prompt-prefix`](https://nix.dev/manual/nix/2.34/command-ref/conf-file#conf-bash-prompt-prefix)
  - [`bash-prompt-suffix`](https://nix.dev/manual/nix/2.34/command-ref/conf-file#conf-bash-prompt-suffix)
  - [`flake-registry`](https://nix.dev/manual/nix/2.34/command-ref/conf-file#conf-flake-registry)
  - [`commit-lock-file-summary`](https://nix.dev/manual/nix/2.34/command-ref/conf-file#conf-commit-lock-file-summary)

## <a id="flake-inputs"></a> Flake inputs
...
## <a id="self-attributes"></a> Self-attributes
