...
برای جلوگیری از ارتقای نسخه فعلی نصب‌شدهٔ Firefox:
...
برای غیرفعال کردن Firefox نصب‌شدهٔ فعلی و سپس نصب یک Firefox جدید، در حالی که نسخه قدیمی همچنان بخشی از پروفایل باقی می‌ماند:
