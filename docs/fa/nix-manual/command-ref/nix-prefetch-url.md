...
- `--type` *hashAlgo*
  ...
  از الگوریتم هش رمزنگاری‌شدهٔ مشخص‌شده استفاده کنید،
...
- `--name` *name*
  ...
  نام فایل را در انبار Nix بازنویسی کنید. به‌طور پیش‌فرض، این نام `hash-basename` است که در آن *basename* آخرین مؤلفهٔ *url* است.
