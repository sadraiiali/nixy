...
- <span id="env-NIX_STORE_DIR">[`NIX_STORE_DIR`](#env-NIX_STORE_DIR)</span>
  ...
  در ویندوز، هیچ تنظیماتی در زمان کامپایل وجود ندارد؛ مقدار پیش‌فرض `%PROGRAMDATA%\nix\store` است که در زمان اجرا با استفاده از [پوشهٔ شناخته‌شدهٔ `%PROGRAMDATA%`](#known-folders) تعیین می‌شود.
...
- <span id="env-NIX_LOG_DIR">[`NIX_LOG_DIR`](#env-NIX_LOG_DIR)</span>
  ...
  در ویندوز، هیچ تنظیماتی در زمان کامپایل وجود ندارد؛ مقدار پیش‌فرض `%PROGRAMDATA%\nix\log` است که در زمان اجرا با استفاده از [پوشهٔ شناخته‌شدهٔ `%PROGRAMDATA%`](#known-folders) تعیین می‌شود.
...
- <span id="env-NIX_STATE_DIR">[`NIX_STATE_DIR`](#env-NIX_STATE_DIR)</span>
  ...
  در ویندوز، هیچ تنظیماتی در زمان کامپایل وجود ندارد؛ مقدار پیش‌فرض `%PROGRAMDATA%\nix\state` است که در زمان اجرا با استفاده از [پوشهٔ شناخته‌شدهٔ `%PROGRAMDATA%`](#known-folders) تعیین می‌شود.
...
- <span id="env-NIX_DAEMON_SOCKET_PATH">[`NIX_DAEMON_SOCKET_PATH`](#env-NIX_DAEMON_SOCKET_PATH)</span>
  ...
  برای جزئیات دربارهٔ نحوه حل مسیر سوکت، به مستندات [انبار دائم محلی][Local Daemon Store] مراجعه کنید.
...
- <span id="env-NIX_PATH">[`NIX_PATH`](#env-NIX_PATH)</span>
  ...
  می‌توان آن را با استفاده از [گزینهٔ `-I`](@docroot@/command-ref/opt-common.md#opt-I) گسترش داد.
