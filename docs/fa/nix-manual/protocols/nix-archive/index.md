...
فرمت آرشیو نیکس (NAR) همچنین به‌طور رسمی با استفاده از [Kaitai Struct](https://kaitai.io/)، یک زبان توصیف رابط (IDL) برای تعریف ساختارهای دادهٔ باینری، توصیف شده‌است.
