...
[الحاق رشته](./operators.md#string-concatenation)،
...
Nix تضمین خواهد کرد که تمام فایل‌های ارجاع‌شده قابل دسترسی باشند - یعنی تمام [مسیرهای انبار](@docroot@/glossary.md#gloss-store-path) [معتبر](@docroot@/glossary.md#gloss-validity) باشند.
...
- [مسیر اشتقاق‌پذیر]{#string-context-element-derived-path}

  یک عنصر زمینه رشته از این نوع، یک [مسیر اشتقاق‌پذیر](@docroot@/glossary.md#gloss-deriving-path) است.
  ...
  - [عناصر زمینه رشته ثابت]{#string-context-constant}
...
[deriving path]: @docroot@/glossary.md#gloss-deriving-path
  ...
  - [عناصر زمینه رشته‌ای خروجی]{#string-context-output}
...
- [*derivation deep*]{#string-context-element-derivation-deep}
  ...
  مفهوم *derivation deep* یک ویژگی پیشرفته است که برای استفاده با [`exportReferencesGraph` derivation attribute](./advanced-attributes.html#adv-attr-exportReferencesGraph) در نظر گرفته شده‌است.
...
[`builtins.unsafeDiscardStringContext`](./builtins.md#builtins-unsafeDiscardStringContext) کپی‌ای از یک رشته، اما با زمینه رشتهٔ خالی ایجاد می‌کند.
...
[`builtins.appendContext`] کپی‌ای از یک رشته، اما با عناصر زمینه رشتهٔ اضافی ایجاد می‌کند.
...
1. ایجاد یک رشته با عناصر زمینه رشتهٔ دلخواه.
