...
> **سازگاری**
        ...
        > و از سال ۲۰۰۵ (تقریباً تمام تاریخچه‌ی Nix) پشتیبانی می‌شود.
  ...
  - [`outputHashAlgo`]{#adv-attr-outputHashAlgo}
    ...
    این گزینه، الگوریتم هش مورد استفاده برای محاسبه‌ی داده‌های [شیء سیستم‌فایل] یک خروجی derivation با آدرس محتوایی را مشخص می‌کند.
    ...
    صفت `outputHashAlgo` الگوریتم هش مورد استفاده برای محاسبه‌ی هش را مشخص می‌کند.
  ...
  - [`outputHash`]{#adv-attr-outputHash}
    ...
    > **نکته**
    >
    > تابع [`convertHash`](@docroot@/language/builtins.md#builtins-convertHash) نحوه‌ی تبدیل بین کدگذاری‌های مختلف را نشان می‌دهد.
    > [دستور `nix-hash`](../command-ref/nix-hash.md) حاوی اطلاعاتی درباره‌ی نحوه‌ی دریافت هش برای برخی محتویات و همچنین تبدیل به کدگذاری‌ها و از آن‌ها است.
