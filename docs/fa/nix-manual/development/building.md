...
این بخش یادداشت‌هایی را دربارهٔ نحوه شروع توسعه و مشارکت در Nix ارائه می‌دهد.
...
برای کسب اطلاعات بیشتر دربارهٔ اجرا و فیلتر کردن تست‌ها، به [`testing.md`](./testing.md) مراجعه کنید.
...
شما می‌توانید به جای `nix-cli-ccacheStdenv` از هر یک از محیط‌های پشتیبانی‌شدهٔ دیگر استفاده کنید.
...
می‌توانید این کار را یا با اجرای آن در داخل محیط توسعه، یا با استفاده از [nix-direnv](https://github.com/nix-community/nix-direnv) و [افزونهٔ مناسب ویرایشگر](https://github.com/direnv/direnv/wiki#editor-integration) انجام دهید.

> **نکته**
>
> برای برخی از ویرایشگرها (مانند Visual Studio Code)، ممکن است نیاز باشد یک [افزونهٔ خاص](https://open-vsx.org/extension/llvm-vs-code-extensions/vscode-clangd) نصب کنید تا ویرایشگر بتواند با `clangd` تعامل داشته باشد.
...
> راه‌اندازی مختص هر ویرایشگر معمولاً سلیقه‌ای است، بنابراین در اینجا جزئیات بیشتری دربارهٔ آن ارائه نمی‌دهیم.
