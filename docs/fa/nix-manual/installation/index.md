...
این بخش نحوه نصب و پیکربندی Nix را برای استفادهٔ بار اول شرح می‌دهد.

گزینهٔ توصیه‌شدهٔ فعلی روی لینوکس و macOS، روش [چندکاربره](#multi-user) است.
...
جامعهٔ کاربری Nix نصب‌کننده‌هایی را برای چندین توزیع نگهداری می‌کند.
