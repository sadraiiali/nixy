...
هنگامی که افراد مورد نظر خود را پیدا کردید، می‌توانید از طریق یکی از [پلتفرم‌های ارتباطی جامعه‌ی کاربری](https://nixos.org/community) با آن‌ها تماس بگیرید:

- [GitHub](https://github.com/nixos)

  تمام کدهای منبع روی گیت‌هاب نگهداری می‌شوند.
  این مکان مناسبی برای بحث درباره‌ی جزئیات پیاده‌سازی است.
...
- جلسات و رویدادها
  ...
  برای رویدادهای زنده یا حضوری، [تقویم رسمی NixOS](https://calendar.google.com/calendar/u/0/embed?src=b9o52fobqjak8oq8lfkhg3t0qg@group.calendar.google.com) و [تقویم جامعه‌ی کاربری Discourse](https://discourse.nixos.org/t/community-calendar/18589) را بررسی کنید.
  برخی از تیم‌های جامعه‌ی کاربری جلسات منظمی برگزار می‌کنند و یادداشت‌های جلسات خود را منتشر می‌سازند.

## مکان‌های دیگر

اگر کاربر یا گروه خاصی را پیدا نکرده‌اید که بتواند در مشارکت به شما کمک کند، می‌توانید با استفاده از یکی از کانال‌های ارتباطی رسمی زیر، از کل جامعه‌ی کاربری سوال بپرسید:
