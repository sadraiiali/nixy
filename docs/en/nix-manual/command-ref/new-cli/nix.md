...
- [`nix help`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-help) - show help about `nix` or a particular subcommand
- [`nix help-stores`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-help-stores) - show help about store types and their settings

**Main commands:**

- [`nix build`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-build) - build a derivation or fetch a store path
- [`nix develop`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-develop) - run a bash shell that provides the build environment of a derivation
- [`nix flake`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake) - manage Nix flakes
- [`nix profile`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-profile) - manage Nix profiles
- [`nix run`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-run) - run a Nix application
- [`nix search`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-search) - search for packages

**Main commands:**

- [`nix repl`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-repl) - start an interactive environment for evaluating Nix expressions

**Infrequently used commands:**

- [`nix bundle`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-bundle) - bundle an application so that it works outside of the Nix store
- [`nix copy`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-copy) - copy paths between Nix stores
- [`nix edit`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-edit) - open the Nix expression of a Nix package in $EDITOR
- [`nix eval`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-eval) - evaluate a Nix expression
- [`nix fmt`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-fmt) - reformat your code in the standard style
- [`nix formatter`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-formatter) - build or run the formatter
- [`nix log`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-log) - show the build log of the specified packages or paths, if available
- [`nix path-info`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-path-info) - query information about store paths
- [`nix registry`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-registry) - manage the flake registry
- [`nix why-depends`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-why-depends) - show why a package has another package in its closure

**Utility/scripting commands:**

- [`nix config`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-config) - manipulate the Nix configuration
- [`nix daemon`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-daemon) - daemon to perform store operations on behalf of non-root clients
- [`nix derivation`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-derivation) - Work with derivations, Nix's notion of a build plan.
- [`nix env`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-env) - manipulate the process environment
- [`nix hash`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-hash) - compute and convert cryptographic hashes
- [`nix key`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-key) - generate and convert Nix signing keys
- [`nix nar`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-nar) - create or inspect NAR files
- [`nix print-dev-env`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-print-dev-env) - print shell code that can be sourced by bash to reproduce the build environment of a derivation
- [`nix realisation`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-realisation) - manipulate a Nix realisation
- [`nix store`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-store) - manipulate a Nix store

**Commands for upgrading or troubleshooting your Nix installation:**

- [`nix upgrade-nix`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-upgrade-nix) - upgrade Nix to the latest stable version
...
[flake reference](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake#flake-references) and *attrpath* is an optional attribute path. For
more information on flakes, see [the `nix flake` manual
page](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-flake). Flake references are most commonly a flake
...
A [store derivation](https://nix.dev/manual/nix/2.34/glossary#gloss-store-derivation) is also addressed by store path.
...
Note that a [store derivation](https://nix.dev/manual/nix/2.34/glossary#gloss-store-derivation) (given by its `.drv` file store path) doesn't have
...
The same information is also available from the [`nix help-stores`](https://nix.dev/manual/nix/2.34/command-ref/new-cli/nix3-help-stores) command.
