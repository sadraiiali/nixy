...
More details on the options can be found in the [`nix-shell` reference documentation](/pages/nix-manual/command-ref/nix-shell#options).
...
- [Garbage Collection](/pages/nix-manual/package-management/garbage-collection) – free up storage used by the programs made available through Nix
