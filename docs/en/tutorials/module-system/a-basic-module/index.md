...
Here's a helper script to parse and evaluate our `default.nix` file with [`nix-instantiate --eval`](/pages/nix-manual/command-ref/nix-instantiate) and print the output as JSON:
