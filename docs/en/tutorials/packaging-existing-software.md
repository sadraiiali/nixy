...
In this tutorial, you'll create your first [Nix derivations](/pages/nix-manual/language/derivations) to package C/C++ software.
...
That variable is accessible in the derivation's [`builder` execution environment](/pages/nix-manual/language/derivations#builder-execution).
