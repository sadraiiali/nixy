...
Configure Nix to use the remote builder by adding to the [Nix configuration file](/pages/nix-manual/command-ref/conf-file-prefix) as `root`:
...
- The *local machine*'s [system type](/pages/nix-manual/command-ref/conf-file-prefix#conf-system)

  This will delegate jobs for that system type to the *remote machine*.

- The location of the SSH key
- A list of [supported system features](/pages/nix-manual/command-ref/conf-file-prefix#conf-system-features)
...
See the [reference documentation on the  `builders` setting](/pages/nix-manual/command-ref/conf-file-prefix#conf-builders) for details.
...
- The location of the SSH key
- Which  *local machine*'s [system type](/pages/nix-manual/command-ref/conf-file-prefix#conf-system)
...
The [`--max-jobs 0` command line argument](/pages/nix-manual/command-ref/conf-file-prefix#conf-max-jobs) forces Nix to build it on the remote builder.
...
:::{tip}
Refer to the [Nix reference manual](/pages/nix-manual/command-ref/conf-file-prefix) for details on the options available in [`nix.settings`](https://search.nixos.org/options?show=nix.settings).
:::
...
- [Nix reference manual: Settings for distributed builds](/pages/nix-manual/command-ref/conf-file-prefix#conf-builders)
