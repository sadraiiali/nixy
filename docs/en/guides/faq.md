...
See the Nix reference manual on [string interpolation](/pages/nix-manual/language/string-interpolation) and [operators on paths and strings](/pages/nix-manual/language/operators#string-concatenation).
